...
import { FlagHttpController } from '../../controllers/v1/flag.http.controller';
...
export default async function (fastify: FastifyInstance) {
  ...
  fastify.route({
    ...
    handler: flagController.getClientFlags.bind(flagController),
  });
  ...
  fastify.route({
    ...
    handler: flagController.evaluateFlag.bind(flagController),
  });
}
